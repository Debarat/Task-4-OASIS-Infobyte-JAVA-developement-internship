...
class login extends JFrame implements ActionListener {
    JButton b1;
    JPanel newPanel;
    JLabel UserLabels, PasswordLabel;
    final JTextField textField1, textField2;

    login() {
        UserLabels = new JLabel();
        UserLabels.setText("    Username :");
...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 0) {
            l.setText("Que1: What is the extension of compiled java classes?");
            jb[0].setText(".txt");
            jb[1].setText(".js");
            jb[2].setText(".class");
            jb[3].setText(".java");
        ...
        if (current == 1) {
            l.setText("Que2:  Which of the below is not a Java Profiler?");
        ...
        if (current == 2) {
            l.setText("Que3: Which of these keywords is used to define interfaces in Java?");
            jb[0].setText("intf");
            jb[1].setText("Intf");
        ...
        if (current == 6) {
            l.setText("Que7: Which exception is thrown when java is out of memory? ");
